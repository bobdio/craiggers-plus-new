var ResultsView = BaseView.extend({
	...
	events : {
		...
		"click .posting .category_container.category_parent" : "categoryGroupIconHandler",
	...
	categoryGroupIconHandler : function () {
		var categoryID = $(event.target).attr("id");

		if (categoryID) {
			this.model.setCategoryGroup(categoryID);
		}
	...
	categoryIconHandler : function (event) {
		...
		this.model.setCategory(categoryID);
