var SavedSearchesView = BaseView.extend({
	...
	events : {
		...
		"click #delete_search_dialog #continue" : "continueHandler"
	},
	...
	deleteSearchHandler : function (event) {
		...
		if (searchModel.id) {
			$("#delete_search_dialog").modal("show");
	...
	removeSearch : function (searchModel) {
		$("#"+searchModel.cid).remove();
		searchService.deleteSavedSearch(searchModel);
		$("#delete_search_dialog").modal("hide");
		this.selectedSearch = null;
	},

	continueHandler : function () {
		this.removeSearch(this.selectedSearch);
	},
