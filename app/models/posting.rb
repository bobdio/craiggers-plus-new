class Posting < ActiveRecord::Base
  ...
  def validate_source(source)
    "Source should have one from next values: INDEE, EBAYC, BKPGE, CRAIG, KIJIJ, JBOOM, APTSD, CARSD" unless %w(INDEE EBAYC BKPGE CRAIG KIJIJ JBOOM APTSD CARSD).include? source
  end
